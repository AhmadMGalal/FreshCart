...
export default function Register() {
  ...
  const schema = Yup.object().shape({
    name: Yup.string()
      ...
      .min(
        3,
        'name should be at least than 3 characters and less than 10 characters'
      )
      .max(
        10,
        'name should be at least than 3 characters and less than 10 characters'
    ...
    phone: Yup.string()
      ...
      .matches(/^01[0125][0-9]{8}$/, 'mobile phone should be valid number'),
    email: Yup.string()
    ...
    rePassword: Yup.string()
      ...
      .oneOf(
        [Yup.ref('password')],
        'repassword should be the same as password'
      ),
  });
